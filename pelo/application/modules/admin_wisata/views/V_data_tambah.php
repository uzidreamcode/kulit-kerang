...
<div class="col-lg-12">
	<div class="panel">
		...
		<!--Input Size-->
		<!--===================================================-->
			<?= form_open_multipart('admin_wisata/tambah_ww/'.$w); ?>
			<div class="panel-body"><div class="form-group">

				<div style="margin-bottom: 20px" class="col-sm-9">
					<input type="text" placeholder="Nama Pariwisata" name="nama" class="form-control input-lg" id="demo-is-inputnormal">
					<input type="hidden" value="<?php echo $w?> " name="id_pulau">
				</div>
				...
				<div class="col-md-6">
					<textarea placeholder="deskripsi" class="form-control" id="inputCity" name="deskripsi" style=" width: 100%; height: 100px; margin-bottom: 20px"></textarea>
				</div>
				<div class="col-md-6">
					<div id="search">
