        ...
        <div class="row">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" style="background-image:url('http://localhost/pelo/images/e1.jpg');">
                        ...
                        <div style="margin: 20px" class="blog-box mt-4 bg-white">
                            ...
                            <div class="blog-contain p-4">
                              ...
                              <h5 class="mt-4">
                                ...
                                <?php
                                $idd=$s->id_wisata;
                                $hkomen = $this->M_data_wisata->hkomen($idd);
                                ?>
...
<section class="section bg-light">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img style="width: inherit;" src="http://localhost/pelo/images/e3.png">
            </div>
        </div>
